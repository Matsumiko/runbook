...
- the task is specifically an inbox surface, review panel, or diff-viewer surface
- the task is specifically an inspector side panel or metadata drawer
