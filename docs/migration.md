...
Core files such as `AGENTS.md`, `CONTEXT.md`, `CODER.md`, `SESSION.md`, `FRONTEND-DNA.md`, and `BACKEND-SECURITY-CHECKLIST.md` remain the main workflow surface.
...
3. Move project-specific commands and architecture notes into `CODER.md`.
